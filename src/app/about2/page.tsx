...
import ThesisColumns from "@/components/sections/ThesisColumns";
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen bg-[#f5f5f3] text-foreground">
        ...
        {/* Hero Statement */}
        <section className="relative overflow-hidden bg-[#f5f5f3] px-6 pt-28 pb-16 md:pt-36 md:pb-24 lg:px-8">
        ...
        {/* Horizontal Scroll Text — "We Back Bold Founders" */}
        ...
        {/* Domain Expertise */}
        <section data-navbar-color="#ffffff" className="relative z-[1] overflow-hidden px-6 py-24 md:py-32 lg:px-8">
          {/* Gradient orbs */}
          <div
            className="pointer-events-none absolute -right-40 top-10 h-[500px] w-[500px] rounded-full opacity-[0.08] blur-3xl"
            style={{ backgroundColor: "#c3b1e1" }}
          />
          <div
            className="pointer-events-none absolute -left-20 bottom-20 h-[400px] w-[400px] rounded-full opacity-[0.08] blur-3xl"
          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            <div className="mt-12 grid gap-4 md:mt-16">
              ...
              <div className="grid gap-4 md:grid-cols-5">
                <div className="group flex min-h-[280px] cursor-pointer flex-col justify-between rounded-2xl border border-white/40 bg-white/60 p-8 shadow-sm backdrop-blur-xl transition-all duration-500 hover:bg-[#6b3ce3] hover:border-transparent md:col-span-3 md:p-10">
                ...
                <div className="group flex min-h-[280px] cursor-pointer flex-col justify-between rounded-2xl border border-white/40 bg-white/60 p-8 shadow-sm backdrop-blur-xl transition-all duration-500 hover:bg-[#e63946] hover:border-transparent md:col-span-2 md:p-10">
                  <h3 className="text-2xl font-bold tracking-tight transition-colors duration-500 group-hover:text-white md:text-3xl">
                    Proven Founders
                  </h3>
                  <p className="text-base leading-relaxed text-foreground/60 transition-colors duration-500 group-hover:text-white/85 md:text-lg">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="group flex min-h-[280px] cursor-pointer flex-col justify-between rounded-2xl border border-white/40 bg-white/60 p-8 shadow-sm backdrop-blur-xl transition-all duration-500 hover:bg-[#0d9488] hover:border-transparent md:p-10">
                  <h3 className="text-2xl font-bold tracking-tight transition-colors duration-500 group-hover:text-white md:text-3xl">
                    Billion-Dollar
                    <br />
                    Builders
                ...
                <div className="group flex min-h-[280px] cursor-pointer flex-col justify-between rounded-2xl border border-white/40 bg-white/60 p-8 shadow-sm backdrop-blur-xl transition-all duration-500 hover:bg-[#2563eb] hover:border-transparent md:p-10">
                  <h3 className="text-2xl font-bold tracking-tight transition-colors duration-500 group-hover:text-white md:text-3xl">
                    Hands-On
                    <br />
                    Advisors
                ...
                <div className="group flex min-h-[280px] cursor-pointer flex-col justify-between rounded-2xl border border-white/40 bg-white/60 p-8 shadow-sm backdrop-blur-xl transition-all duration-500 hover:bg-[#ea580c] hover:border-transparent md:p-10">
                  <h3 className="text-2xl font-bold tracking-tight transition-colors duration-500 group-hover:text-white md:text-3xl">
                    Scaling Celebrity
                    <br />
                    Influence
          ...
          <div className="relative z-10 mx-auto grid max-w-6xl gap-16 md:grid-cols-2 md:gap-20">
            ...
            <div className="flex flex-col gap-0">
              ...
              <div className="flex items-start gap-8 pb-10 pt-2">
                ...
                <h3 className="text-2xl font-bold leading-tight tracking-tight text-foreground md:text-3xl lg:text-4xl">
                  Celebrity Strategy
                  <br />
                  &amp; Brokering.
                </h3>
        ...
        <section className="px-6 py-24 md:py-32 lg:px-8">
          <div className="mx-auto max-w-6xl">
            <div className="relative overflow-hidden rounded-3xl bg-[#f4b8c1] px-8 py-16 md:px-16 md:py-24">
              <div className="relative flex flex-col items-center text-center">
                <h2 className="text-4xl font-extrabold tracking-tight text-[#1a1a2e] md:text-5xl lg:text-6xl">
                  Let&apos;s build something
                  <br />
                  extraordinary together.
                </h2>
                <p className="mt-6 max-w-lg text-lg leading-relaxed text-[#1a1a2e]/70 md:text-xl">
                  Whether you&apos;re a founder with a vision or an investor looking for
                  the next big opportunity, we want to hear from you.
                </p>
                <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
                  <a
                    href="/contact"
                    className="inline-flex items-center gap-2 rounded-full bg-[#1a1a2e] px-8 py-4 text-sm font-bold text-white transition-opacity hover:opacity-90"
                  >
                    Pitch Us
                    <span className="text-lg">&rarr;</span>
                  </a>
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full border-2 border-[#1a1a2e] px-8 py-4 text-sm font-bold text-[#1a1a2e] transition-colors hover:bg-[#1a1a2e] hover:text-white"
                  >
                    Become an Angel
                    <span className="text-lg">&rarr;</span>
                  </a>
